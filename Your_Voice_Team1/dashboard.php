...
<body>
	<div class="container-dashboard">
		Welcome to the dashboard! <span class="user-name">
        <!-- <?php echo ucwords($_SESSION['first_name'])?>  </span>  -->
		<br>

        <div class="card" style="width: 18rem;">
  <img class="card-img-top" src="movies.jpg" width=500px alt="Card image cap">
  <div class="card-body">
...
<div class="card" style="width: 18rem;">
  <img class="card-img-top" src="mobile.jpeg" width=500px alt="Card image cap">
  <div class="card-body">
